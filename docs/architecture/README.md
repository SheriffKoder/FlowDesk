...
How FlowDesk’s Customer Health surface is put together. Read ADRs for *why*; these docs for *how*.

| Doc | Covers |
|---|---|
| [rendering.md](./rendering.md) | Server Components, client islands, loading boundaries |
